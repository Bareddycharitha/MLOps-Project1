    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        ...
        try:
            ...
            if MongoDBClient.client is None:
                mongo_db_uri = os.getenv(MONGODB_URI_KEY)  # Retrieve MongoDB URL from environment variables
                if mongo_db_uri is None:
                    raise Exception(f"Environment variable '{MONGODB_URI_KEY}' is not set.")
